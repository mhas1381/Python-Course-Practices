...
start_bt = Button(text="Start", bg=YELLOW, highlightthickness=0, command=start_timer)
start_bt.grid(row=2, column=0)

reset_bt = Button(text="Reset", bg=YELLOW, highlightthickness=0, command=reset_timer)
